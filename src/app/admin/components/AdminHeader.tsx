...
export default function AdminHeader({ tab, crisisMode, crisisLoading, toggleCrisisMode }: AdminHeaderProps) {
    ...
    <header className="sticky top-0 z-30 bg-[#050507]/80 backdrop-blur-xl border-b border-[#1E1E28]">
      <div className="flex items-center justify-between px-6 py-3">
        <div>
          ...
          <p className="text-[10px] text-[#7C7C8A]">{meta.description}</p>
        </div>

        <div className="flex items-center gap-4">
          {/* Crisis Mode Toggle */}
          <div className="flex items-center gap-2.5 px-3 py-1.5 rounded-lg border border-[#1E1E28] bg-[#0C0C10]">
